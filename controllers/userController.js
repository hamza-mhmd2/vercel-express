...
import User from '../models/userSchema.js'; // Assuming your User model is in models/User.js
...
export const login = async (req, res) => {
  ...
  try {
    ...
    // Generate JWT token
    const token = jwt.sign({ id: user._id }, 'carpool', { expiresIn: '1h' });
...
export const getDriverById = async (req, res) => {
  try {
      ...
      const driver = await User.findById(driverId);  // Assuming you're using Mongoose
